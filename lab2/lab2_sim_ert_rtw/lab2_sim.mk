###########################################################################
## Makefile generated for component 'lab2_sim'. 
## 
## Makefile     : lab2_sim.mk
## Generated on : Mon Jul 13 18:27:44 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab2_sim.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab2_sim.elf
...
DEFINES_STANDARD = -DMODEL=lab2_sim -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = encoder_arduino.o xcp_ext_mode.o lab2_sim.o lab2_sim_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/lab2_sim_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/lab2_sim_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/lab2_sim_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/lab2_sim_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


lab2_sim.o : $(START_DIR)/lab2_sim_ert_rtw/lab2_sim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


lab2_sim_data.o : $(START_DIR)/lab2_sim_ert_rtw/lab2_sim_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/lab2_sim_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/lab2_sim_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/lab2_sim_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
