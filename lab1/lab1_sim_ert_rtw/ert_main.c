...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T) lab1_sim_M->Timing.clockTick0;
  lab1_sim_step();
...
int main(void)
{
  ...
  init();
  MW_Arduino_Init();
  rtmSetErrorStatus(lab1_sim_M, 0);
  ...
  errorCode = extmodeInit(lab1_sim_M->extModeInfo, &rtmGetTFinal(lab1_sim_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(lab1_sim_M, true);
    }
  }
  ...
  runModel = !extmodeSimulationComplete() && !extmodeStopRequested() &&
    !rtmGetStopRequested(lab1_sim_M);
