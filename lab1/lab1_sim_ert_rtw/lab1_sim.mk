###########################################################################
## Makefile generated for component 'lab1_sim'. 
## 
## Makefile     : lab1_sim.mk
## Generated on : Mon Jul 13 16:50:13 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab1_sim.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab1_sim.elf
...
DEFINES_STANDARD = -DMODEL=lab1_sim -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o xcp_ext_mode.o lab1_sim.o lab1_sim_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/lab1_sim_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/lab1_sim_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/lab1_sim_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/lab1_sim_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


lab1_sim.o : $(START_DIR)/lab1_sim_ert_rtw/lab1_sim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


lab1_sim_data.o : $(START_DIR)/lab1_sim_ert_rtw/lab1_sim_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
