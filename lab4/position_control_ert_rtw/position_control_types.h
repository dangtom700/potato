...
#ifndef typedef_Encoder_arduino_position_cont_T
#define typedef_Encoder_arduino_position_cont_T

typedef struct tag_LZATNKaowXRlwzpKcQ6wRE Encoder_arduino_position_cont_T;

#endif                             /* typedef_Encoder_arduino_position_cont_T */
