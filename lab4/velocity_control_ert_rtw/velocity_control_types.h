...
#ifndef RTW_HEADER_velocity_control_types_h_
#define RTW_HEADER_velocity_control_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
#ifndef typedef_Encoder_arduino_velocity_cont_T
#define typedef_Encoder_arduino_velocity_cont_T

typedef struct tag_LZATNKaowXRlwzpKcQ6wRE Encoder_arduino_velocity_cont_T;

#endif                             /* typedef_Encoder_arduino_velocity_cont_T */
...
typedef struct P_velocity_control_T_ P_velocity_control_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_velocity_control_T RT_MODEL_velocity_control_T;

#endif                                /* RTW_HEADER_velocity_control_types_h_ */
